package flexUnitTests
{
	...
	public class AsbertTest {
		...
		public function shouldEncodeAtom():void {
			var atom:BertAtom = new BertAtom("hello");
			var encoded:String = Bert.encode(atom);
		...
		public function shouldEncodeBinary():void {
			var binary:BertBinary = new BertBinary("hello");
			var encoded:String = Bert.encode(binary);
			var list:Array = Bert.binaryToList(encoded);		
